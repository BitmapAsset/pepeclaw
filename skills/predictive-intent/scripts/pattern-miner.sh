...
#
# Usage: ./pattern-miner.sh
#
# Runs daily at 1 AM via cron. Reads request-log.json, discovers recurring
# daily/weekly/sequential patterns, and writes to patterns.json.
