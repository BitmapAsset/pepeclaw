...
ANALYSIS_DIR="${ANALYSIS_DIR:-$OPENCLAW_HOME/data/meta-learning/daily}"
PROPOSALS_DIR="${PROPOSALS_DIR:-$OPENCLAW_HOME/data/meta-learning/proposals}"
METRICS_DIR="${METRICS_DIR:-$OPENCLAW_HOME/data/meta-learning/metrics}"
