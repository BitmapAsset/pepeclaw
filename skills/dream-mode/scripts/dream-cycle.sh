...
# Part of the Dream Mode skill for Pepe 2.0
#
# Usage: ./dream-cycle.sh
#
# Runs daily at 2 AM via cron. Spawns creative exploration threads using
# different creative lenses, scores results by novelty and feasibility,
# and writes promoted dreams to DREAM_LOG.md.
...
DREAM_LOG="${SKILL_DIR}/DREAM_LOG.md"
