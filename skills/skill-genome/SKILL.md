...
The fitness tracker should be called after every skill invocation. Add to the
post-invocation hook in the OpenClaw gateway:

```bash
# After skill completes, log the outcome
